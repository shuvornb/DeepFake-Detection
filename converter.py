...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 28 00:16:33 2020

@author: shiva
"""

# this code reads the video content fetches the faces from it frames in the video and stores the faces in 256 x 256 format
...
def saveFaces(generator,batch_size = 50):
    ...
    for epoch in range(n // batch_size + 1): 
        ...
        for img in face_batch:
            ...
            imgname = r'/home/shiva/Desktop/MesoNet-master/test_images/real/'+'image_'+str(videono)+'_'+str(i)+'.png'
            i +=1
            merged.save(imgname)
